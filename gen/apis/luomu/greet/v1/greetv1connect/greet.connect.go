...
import (
	...
	v1 "github.com/luomu/clean-code/gen/apis/luomu/greet/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GreetServiceName = "apis.luomu.greet.v1.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/apis.luomu.greet.v1.GreetService/Greet"
)

// GreetServiceClient is a client for the apis.luomu.greet.v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *connect_go.Request[v1.GreetRequest]) (*connect_go.Response[v1.GreetResponse], error)
}

// NewGreetServiceClient constructs a client for the apis.luomu.greet.v1.GreetService service. By
...
// Greet calls apis.luomu.greet.v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the apis.luomu.greet.v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/apis.luomu.greet.v1.GreetService/", mux
}
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect_go.Request[v1.GreetRequest]) (*connect_go.Response[v1.GreetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("apis.luomu.greet.v1.GreetService.Greet is not implemented"))
}
